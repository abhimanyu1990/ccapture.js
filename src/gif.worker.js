    ...
    (a.modules = {}),
        ...
        a.define("/gif.worker.coffee", function (d, e, f, g) {
            ...
            (b = a("/GIFEncoder.js", d)),
                (c = function (a) {
                    var c, e, d, f;
                    console.log("gifencoder  == a === ",a.transparent)
                    return (
            ...
            function C(A, B) {
                ...
                function E(j, i, k) {
                    var b,
                        ...
                        g = f - 1;
                    while (f < a || g >= 0)
                        f < a && ((d = o[f]), (c = d[1] - i), c >= e ? (f = a) : (f++, c < 0 && (c = -c), (b = d[0] - j), b < 0 && (b = -b), (c += b), c < e && ((b = d[2] - k), b < 0 && (b = -b), (c += b), c < e && ((e = c), (h = d[3]))))),
                            g >= 0 &&
                                ((d = o[g]), (c = i - d[1]), c >= e ? (g = -1) : (g--, c < 0 && (c = -c), (b = d[0] - j), b < 0 && (b = -b), (c += b), c < e && ((b = d[2] - k), b < 0 && (b = -b), (c += b), c < e && ((e = c), (h = d[3])))));
                    return h;
                }
                function F() {
                    var c,
